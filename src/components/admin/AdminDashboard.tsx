      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-sage/10">
            <LayoutDashboard size={20} className="text-sage" />
          </div>
          <h1 className="text-2xl font-bold text-dark">CMS Dashboard</h1>
        </div>
      </div>

      <div className="rounded-2xl p-8 bg-white border border-sage/10 shadow-sm">
        <h2 className="text-lg font-semibold text-dark mb-4">Manage CMS Dashboard</h2>
        <p className="text-gray mb-6">This CMS section allows you to manage your CMS Dashboard. Full editing capabilities coming soon.</p>
