  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      ...
      <div className="rounded-2xl p-8 bg-white border border-sage/10 shadow-sm">
        <h2 className="text-lg font-semibold text-dark mb-4">Manage Blog Posts</h2>
        <p className="text-gray mb-6">This CMS section allows you to manage your Blog Posts. Full editing capabilities coming soon.</p>
