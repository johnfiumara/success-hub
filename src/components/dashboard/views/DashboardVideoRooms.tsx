    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="heading-1 text-dark">Video Rooms</h1>
        </div>
      </div>
      <p className="body text-gray -mt-4 ml-14">Join or create video co-working rooms</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 rounded-2xl p-6 bg-white/80 backdrop-blur-xl border border-white/60 shadow-glass">
          ...
          <p className="text-body text-gray">This section is being built. Check back soon for the full Video Rooms experience.</p>
        </div>
